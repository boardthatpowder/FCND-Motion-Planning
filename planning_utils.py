...
def a_star(graph, h, start, goal):
    """Refactored a_star to use a graph instead of a grid with diaganol actions."""
...
def closest_point(graph, current_point):
    ...
    """
    print ('finding closest_point for current_point: {}',format(current_point))
    closest_point = None
    dist = 100000
    ...
    for next_node in graph[closest_point]:
        print ('closest_point: next_node:{}'.format(graph.edges[closest_point, next_node]))
